...
# --- Baseline resolution on update ---
# Tests kraken baselines are preserved or replaced appropriately. Does not test API routes.
...
# --- Polygon-copy baseline replacement ---
# Tests auto-derived baseline when existing baseline mirrors polygon points.
