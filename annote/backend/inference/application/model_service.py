"""Inference catalog, scoped bindings, and resolver use cases."""
...
from backend.inference.infrastructure.model_repository import InferenceRepository
...
class InferenceModelService:
    def __init__(
        self,
        inference: InferenceRepository | None = None,
        projects: ProjectRepository | None = None,
        documents: DocumentRepository | None = None,
    ) -> None:
        self._inference = inference or InferenceRepository()
