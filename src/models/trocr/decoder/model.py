...
"""Checkpoint-compatible local TrOCR decoder for the Hugging Face small model.

This mirrors Transformers 4.26.1 while preserving the module hierarchy required
by Microsoft TrOCR checkpoint keys and Hugging Face generation.
"""
