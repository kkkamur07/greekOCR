...
"""Checkpoint-compatible local ViT encoder for TrOCR-base.

Local copy of the installed Hugging Face ViT implementation. Its module
hierarchy intentionally matches Transformers so TrOCR-base checkpoint weights
load without state-dict key changes."""
...
__all__ = ["ViTEmbeddings", "ViTAttention", "ViTMLP", "ViTLayer", "ViTPooler", "ViTModel", "ViTPreTrainedModel"]
