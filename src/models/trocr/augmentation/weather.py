...
class Frost:
    ...
    def __call__(self, img, mag=-1, prob=1.):
        ...
        filename = [str(files(__package__).joinpath('frost/frost1.png')),
                    str(files(__package__).joinpath('frost/frost2.png')),
                    str(files(__package__).joinpath('frost/frost3.png')),
                    str(files(__package__).joinpath('frost/frost4.jpg')),
                    str(files(__package__).joinpath('frost/frost5.jpg')),
                    str(files(__package__).joinpath('frost/frost6.jpg'))
                    ]
