...
> **Status: completed** (issues 018–027). Superseded for new work by `nomicous/` platform issues and [`inference/prd-local-inference-helper.md`](../inference/prd-local-inference-helper.md).
