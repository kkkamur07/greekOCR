...
Next.js App Router client shell for the Nomikos production platform API. The app provides
...
Run frontend commands from `nomikos/frontend/`.
...
Domain language follows `nomikos/CONTEXT.md`: Page, Document part, Segment, Text
...
3. Start the API from `nomikos/`.
4. Start Next.js from `nomikos/frontend/`.
