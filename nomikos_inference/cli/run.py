...
Nothing at module scope imports the model runtime. `nomikos_inference/cli/main.py`
...
from nomikos_inference.cli.credentials import CredentialError, credential_path, load_credential
