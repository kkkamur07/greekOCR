...
class MockPublishClient:
    ...
    collection_updates: list[tuple[str, str | None, str | None]] = field(default_factory=list)
    collection_items: list[tuple[str, str, str, str | None]] = field(default_factory=list)
