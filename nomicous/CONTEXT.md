...
annote backend is now the **platform FastAPI app** in `nomicous/backend/`, composed from `backend/core` plus bounded contexts for users, projects, documents, annotation, ML, and jobs.
