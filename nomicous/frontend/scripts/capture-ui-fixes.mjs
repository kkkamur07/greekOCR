...
async function main() {
  ...
  await shot(
    page,
    "01-draft-badge-document-header",
  ...
  await shot(
    page,
    "02-draft-badge-documents-table",
  ...
  await page.waitForSelector(".pe-canvas-wrap, .pe-toolbar", {
    timeout: 20000,
  });
  ...
  await shot(
    page,
    "03-transcription-ground-truth-only",
    page.locator(".pe-strip"),
  );
  ...
  await page.waitForSelector(".public-page-canvas__image, .pub-canvas", {
    timeout: 20000,
  });
